...
class DBWNode(object):
    def __init__(self):
        ...
        self.current_velocity_sub = rospy.Subscriber("/current_velocity", TwistStamped, self.current_vel_cb)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if None not in (self.cur_vel, self.linear_vel, self.angular_vel):
                self.throttle, self.brake, self.steering = self.controller.control(self.cur_vel, self.dbw_enabled, self.linear_vel, self.angular_vel)
